      ...
      <main className="max-w-6xl mx-auto  p-2 flex flex-col lg:flex-row space-y-10 space-x-5 pr-10">
        ...
        <section className="flex-1 space-y-5 pb-20 lg:pb-0">
          ...
          <div className="grid grid-cols-2 items-center py-2">
            ...
            <button className="bg-cus_blue col-start-2 mt-2 font-bold rounded-full w-44 py-4 px-10">
              Buy Now
            </button>
          </div>
          ...
          <div className="grid grid-cols-2 spacey-y-2 items-center justify-end">
            ...
            />
            <button className="bg-cus_red font-bold rounded-full w-44 py-4 px-10">
