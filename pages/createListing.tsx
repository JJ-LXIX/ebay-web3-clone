      ...
      createDirectListing(
        {
          ...
          listingDurationInSeconds: 60 * 60 * 24 * 7, //a week
          quantity: 1,
    ...
    <div>
      ...
      <main className="max-w-6xl mx-auto p-10 pt-2">
        ...
        <h2 className="text-xl font-semibold pt-5">
          Select an Iem you would like to Sell
        </h2>
        <hr className="mb-5" />
        ...
        <div className="flex overflow-x-scroll space-x-2 p-4 ">
          {ownedNfts?.data?.map((nft) => (
            <div
              ...
              className={`flex flex-col space-y-2 card min-w-fit border-2 bg-zinc-700 ${
        ...
        {selectedNft && (
          <form onSubmit={handleCreateListing}>
            <div className="flex flex-col p-10">
              ...
              <button
                type="submit"
                className="bg-cus_blue text-white rounded-lg p-4 mt-8"
              >
                Create Listing
              </button>
            </div>
